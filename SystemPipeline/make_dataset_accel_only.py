...
dataset = DatasetHandler.from_csv_directory(path='/Users/oji/Workspace/Self/GraduationProject/SystemPipeline/data/our_data/ameer/6a', overlap=0.0, vector_maker=vector_maker)
